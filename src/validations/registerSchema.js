...
const registerSchema = Joi.object({
  name: Joi.string().min(3).max(50).required().messages({
    "string.base": SCHEMA_VALIDATION.NAME.BASE,
    "string.empty": SCHEMA_VALIDATION.NAME.EMPTY,
    "string.min": SCHEMA_VALIDATION.NAME.MIN,
    "string.max": SCHEMA_VALIDATION.NAME.MAX,
    "any.required": SCHEMA_VALIDATION.NAME.REQUIRED,
  }),
  ...
  role: Joi.string().valid("admin", "user").default("user").messages({
    "string.base": SCHEMA_VALIDATION.ROLE.BASE,
    "string.empty": SCHEMA_VALIDATION.ROLE.EMPTY,
    "any.only": SCHEMA_VALIDATION.ROLE.ONLY,
  }),
});
